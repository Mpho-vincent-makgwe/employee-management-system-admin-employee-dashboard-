...
export default function AssignRoles({ assign }) {
  ...
  <div className="flex items-center gap-4 pt-6">
    <button
      ...
      className="px-6 py-2 w-[212px] h-[50px] bg-[#4F46E5] text-white text-sm font-medium rounded-sm hover:bg-[#4338CA] transition-all"
    >
      Assign
    </button>
    <button
      ...
      className="px-6 py-2 w-[212px] h-[50px] border border-[#D0D5DD] text-gray-700 text-sm font-medium rounded-sm hover:bg-gray-50 transition-all"
    >
      Cancel
    </button>
  </div>
