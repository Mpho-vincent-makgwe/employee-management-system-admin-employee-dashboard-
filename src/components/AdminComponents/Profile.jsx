     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-white rounded-lg p-6">
        ...
        <div className="col-span-1 md:col-span-2 pl-5 border-l border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-7">
            ...
            <DetailField label="Marital Status" value={adminData.maritalStatus} />
            ...
            <DetailField label="Contact Number" value={adminData.contactNumber} />
            <DetailField label="Emergency Number" value={adminData.emergencyNumber} />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <DetailField label="Employment Type" value={adminData.employmentType} />
            <DetailField label="Date of Joining" value={adminData.dateOfJoining} />
